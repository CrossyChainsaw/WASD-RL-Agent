...
class WinFormsGameEnv(gym.Env):
    def __init__(self):
        ...
        self.observation_space = spaces.Tuple((
            spaces.Discrete(10000),  # x: score or numerical value (0 to 100000)
            spaces.Discrete(4),       # a: action (W=0, A=1, S=2, D=3)
            spaces.Discrete(4),       # b: action (W=0, A=1, S=2, D=3)
            spaces.Discrete(4)        # c: action (W=0, A=1, S=2, D=3)
        ))
